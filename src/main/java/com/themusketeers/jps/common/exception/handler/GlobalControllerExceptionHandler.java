...
/*-----------------------------------------------------------------------------
 History
 Mar.9/2024  COQ  File created.
 -----------------------------------------------------------------------------*/
package com.themusketeers.jps.common.exception.handler;

import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.ERROR_CATEGORY_GENERIC;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.ERROR_CATEGORY_PARAMETERS;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.PROPERTY_ERRORS;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.PROPERTY_ERROR_CATEGORY;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.PROPERTY_TIMESTAMP;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.REST_CLIENT_API_CALL_ISSUE;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.TITLE_BAD_REQUEST_ON_PAYLOAD;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.TITLE_TODO_NOT_FOUND;
import static com.themusketeers.jps.common.constants.ControllerExceptionHandlerConstants.TITLE_VALIDATION_ERROR_ON_SUPPLIED_PAYLOAD;
import static com.themusketeers.jps.common.constants.GlobalConstants.COLON_SPACE_DELIMITER;
import static com.themusketeers.jps.common.constants.TodoConstants.TODO_API_V1_URL;
